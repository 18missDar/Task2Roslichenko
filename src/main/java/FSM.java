...
public class FSM {
    ...
    private Map<PairforFSM, String> states;
    ...
    public FSM(Map<PairforFSM, String> states,
               Set<String> start,
               Set<String> finish) {
        this.states = states;
        this.start = start;
    ...
    private Set<String> findNextStates(String input, Set<String> currentStates) {
        ...
        for(Map.Entry<PairforFSM, String> st : this.states.entrySet()) {
    ...
    public Map<PairforFSM, String> getStates() {
        return states;
    }

    public void setStates(Map<PairforFSM, String> states) {
        this.states = states;
    }
